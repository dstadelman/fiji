...
public class PortfolioTrade {
    ...
    public PortfolioTrade(Trade trade, int quantity, Date dateEntry, Date dateExit) {
        this.trade = trade;
        this.quantity = quantity;
        this.dateEntry = Instant.ofEpochMilli(dateEntry.getTime()).atZone(ZoneId.systemDefault()).toLocalDate();
        this.dateExit  = Instant.ofEpochMilli(dateExit.getTime()).atZone(ZoneId.systemDefault()).toLocalDate();
