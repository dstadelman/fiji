...
SELECT quote_date, expiration, strike, option_type, underlying_symbol, root, (bid_1545 + ask_1545) / 2 AS mid_1545 FROM quotes WHERE expiration = '2004-04-17' ORDER BY quote_date
