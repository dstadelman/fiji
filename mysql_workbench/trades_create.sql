...
CREATE TABLE `trades` (
  ...
  `outright_idquotes` int DEFAULT NULL,
  `outright_quantity` int DEFAULT NULL,
  ...
  KEY `idx_outright_idquotes` (`outright_idquotes`),
  ...
  CONSTRAINT `outright_idquotes` FOREIGN KEY (`outright_idquotes`) REFERENCES `quotes` (`idquotes`),
